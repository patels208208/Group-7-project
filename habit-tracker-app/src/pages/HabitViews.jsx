...
function HabitViews() {
	...
	return (
		<div className="flex flex-col items-center mt-3">
			<div className="mt-4">
				<select
					className="form-select text-l p-1 rounded-md border-none shadow-md bg-ghostWhite-300 ring-1 ring-inset ring-melon-500 focus:outline-none focus:ring-inset focus:ring-2 focus:ring-melon-300"
					value={view}
