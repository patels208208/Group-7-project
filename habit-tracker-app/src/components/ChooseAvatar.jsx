      ...
      <div className="flex flex-wrap justify-center gap-4">
        <img
          ...
          className={`w-24 h-24 object-cover cursor-pointer ${
            selectedAvatarName === "Avatar 1" ? "border-4 border-green-500" : ""
          }`}
        />
        <img
          src={Avatar2}
          ...
          className={`w-24 h-24 object-cover cursor-pointer ${
            selectedAvatarName === "Avatar 2" ? "border-4 border-green-500" : ""
          }`}
        />
        <img
          src={Avatar3}
          ...
          className={`w-24 h-24 object-cover cursor-pointer ${
            selectedAvatarName === "Avatar 3" ? "border-4 border-green-500" : ""
          }`}
        />
        <img
          src={Avatar4}
          ...
          className={`w-24 h-24 object-cover cursor-pointer ${
            selectedAvatarName === "Avatar 4" ? "border-4 border-green-500" : ""
          }`}
        />
      </div>
    </div>
