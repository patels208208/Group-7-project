...
// export const GoalCompletion = (props) => {
//   const [userHabitId, setHabitID] = useState(1);
...
//   //           setCompletionStatus(response.data); // Set the state with the fetched data if needed
//   //         } catch (error) {
